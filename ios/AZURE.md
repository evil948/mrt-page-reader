...
> **Если Azure-аккаунт не создаётся** («Вы не имеете права на учетную запись Azure») — используйте вместо этого **[GitHub Actions](GITHUB_ACTIONS.md)**. Репозиторий уже на GitHub, отдельный Azure не нужен.
